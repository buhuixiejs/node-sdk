...
const fs = require('fs');
const path = require('path');  //私钥和目录的地址
const chaincodePath = 'chaincode/github.com/mycc';
const certPath = './first-network/crypto-config/peerOrganizations/org1.example.com/tlsca/tlsca.org1.example.com-cert.pem';  //TLs
// 初始化
